        ...
        <main>
			...
			<div class="menuItem">
				...
				<table class="mTable">
					<tr>
						<td class = "TEdit">
							<li>The Cleanser <span class="price">$20.99</span></li>
							A prune based smoothie with yogurt and oatmeal topped with fresh apple slices and coffee beans
						</td>
						<td class = "TEdit">
							<li>The Windy Mill<span class="price">$21.39</span></li>
							A tossed salad of fresh spinach and broccoli with a prune vinaigrette
						</td>
				</table>
				</ul>
