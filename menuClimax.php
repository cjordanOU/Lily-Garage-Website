        ...
        <main>
			...
			<div class="menuItem">
				...
				<table class="mTable">
					<tr>
						<td class = "TEdit">
							<li>The Ecstasy Burger <span class="price">$20.99</span></li>
							1/3lb. Patty stuffed with your choice of cheese, applewood smoked bacon, sauteed onion, and a perfectly fried egg
						</td>
						<td class = "TEdit">
							<li>The Jimmy Wrap<span class="price">$21.39</span></li>
							Grilled chicken wrap with lettuce, tomato, and topped with ranch dressing 
						</td>
				</table>
				</ul>
