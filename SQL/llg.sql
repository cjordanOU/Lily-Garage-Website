...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2020 at 04:31 PM
...
CREATE TABLE `users` (
  `user_id` int(4) NOT NULL COMMENT 'Unique ID of the user',
  `first_name` char(50) NOT NULL COMMENT 'First name of the user',
  `last_name` char(50) NOT NULL COMMENT 'Last name of the user',
  `user_email` char(100) NOT NULL COMMENT 'Email address of the user',
  `user_phone` char(20) NOT NULL COMMENT 'Phone number of the user',
  `store_location` char(20) NOT NULL COMMENT 'Store location of the user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `user_email`, `user_phone`, `store_location`) VALUES
(1, 'Testfirst', 'Testlast', 'test@test.com', '555-555-5555', 'Ann Arbor, MI');
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID of the user', AUTO_INCREMENT=2;
COMMIT;
