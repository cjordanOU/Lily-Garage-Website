        ...
        <main>
			...
			<div class="menuItem">
				...
				<table class="mTable">
					<tr>
						<td class = "TEdit">
							<li>The Swirly <span class="price">$20.99</span></li>
							A chocolate vanilla ice cream shake topped with Kitkat bites and With a peanut butter drizzle
						</td>
						<td class = "TEdit">
							<li>The Jimmy Wrap<span class="price">$21.39</span></li>
							Two golden brown waffles drizzled with Hershey’s Chocolate sauce and chocolate chips
						</td>
				</table>
				</ul>
