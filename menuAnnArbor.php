        ...
        <main>
			...
			<div class="menuItem">
				...
				<table class="mTable">
					<tr>
						<td class = "TEdit">
							<li>The Long Johnny <span class="price">$20.99</span></li>
							Italian sub on a 12” Italian cheese roll stuffed with pickles and our creamy aioli
						</td>
						<td class = "TEdit">
							<li>The Thunder Down Under<span class="price">$21.39</span></li>
							A crawfish basket piled high with fries and hushpuppies
						</td>
				</table>
				</ul>
